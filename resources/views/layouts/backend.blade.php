...
<body>
  ...
  <!--
        ...
        HEADER STYLE
            ...
            'side-trans-enabled'                       Dark themed Header (works only with classic Header style)
        ...
        MAIN CONTENT LAYOUT
            ...
            side-trans-enabled full size
            sidebar-o enable-page-overlay side-scroll page-header-modern main-content-boxed
        -->
          ...
          <div class="content-header-section text-center align-parent sidebar-mini-hidden">
            ...
            <div class="content-header-item">
              <a class="link-effect font-w700" href="/">
                ...
                <span class="font-size-xl text-dual-primary-dark">Inve</span><span
                  class="font-size-xl text-primary">ntory</span>
              </a>
            </div>
            <!-- END Logo -->
          </div>
        ...
        <div class="content-side content-side-full">
          <ul class="nav-main">
            <li>
              ...
              <a class="{{ request()->is('admin.dash') ? ' active' : '' }}" href="{{ route('admin.dash') }}">
                <i class="si si-cup"></i><span class="sidebar-mini-hide">Dashboard Admin</span>
              </a>
            </li>
          ...
          <div class="btn-group" role="group">
            ...
            <div class="dropdown-menu min-width-300" aria-labelledby="page-header-options-dropdown">
              ...
              <div class="row no-gutters text-center mb-5">
                ...
                <div class="col-2 mb-5">
                  <a class="text-elegance" data-toggle="theme" data-theme="{{ mix('/css/themes/elegance.css') }}"
                    href="javascript:void(0)">
                    <i class="fa fa-2x fa-circle"></i>
                  </a>
                </div>
                <div class="col-2 mb-5">
                  <a class="text-pulse" data-toggle="theme" data-theme="{{ mix('/css/themes/pulse.css') }}"
                    href="javascript:void(0)">
                    <i class="fa fa-2x fa-circle"></i>
                  </a>
                </div>
                ...
                <div class="col-2 mb-5">
                  <a class="text-corporate" data-toggle="theme" data-theme="{{ mix('/css/themes/corporate.css') }}"
                    href="javascript:void(0)">
                    <i class="fa fa-2x fa-circle"></i>
                  </a>
                </div>
                <div class="col-2 mb-5">
                  <a class="text-earth" data-toggle="theme" data-theme="{{ mix('/css/themes/earth.css') }}"
                    href="javascript:void(0)">
                    <i class="fa fa-2x fa-circle"></i>
                  </a>
                </div>
